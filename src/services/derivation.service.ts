...
import {Wallet, MnemonicPassPhrase, ExtendedKey} from 'symbol-hd-wallets'
...
export class DerivationService {
 ...
 /**
  * Returs an account from a mnemonic and a path index
  * @static
  * @param {string} mnemonic
  * @param {number} pathNumber
  * @returns {Account}
  */
 public static getAccountFromMnemonic(mnemonic: string, pathNumber: number): Account {
  ...
  return new Wallet(extendedKey).getChildAccount(path)
 }
}
